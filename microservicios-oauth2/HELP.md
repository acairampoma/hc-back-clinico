...
* The original package name 'com.andres.springcloud.msvc.oauth.msvc-oauth' is invalid and this project uses 'com.andres.springcloud.msvc.oauth.msvc_oauth' instead.
